...
print(beneficiario)
print('El descuento por edad es: %', descuentoEdad)
print('El descuento por ingreso familiar es: %', descuentoIngreso)
print('El descuento por puntaje de examen es: %',descuentoPuntaje)
print('El descuento total sobre el valor de la matricula es: %',descuentoTotal)
